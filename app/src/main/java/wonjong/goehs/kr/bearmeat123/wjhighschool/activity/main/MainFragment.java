package wonjong.goehs.kr.bearmeat123.wjhighschool.activity.main;
...
import wonjong.goehs.kr.bearmeat123.wjhighschool.activity.exam.ExamTimeActivity;
...
import wonjong.goehs.kr.bearmeat123.wjhighschool.tool.Preference;
import wonjong.goehs.kr.bearmeat123.wjhighschool.tool.RecyclerItemClickListener;
                    ...
                    switch (position) {
                        case 0:
                           startActivity(new Intent(getActivity(), NoticeActivity.class));
                            break;
                        case 1:
                            Toast.makeText(getActivity(), "개발자의 노력부족으로 2019년부터 지원할 예정 ㅜㅜ", Toast.LENGTH_SHORT).show();
//                            startActivity(new Intent(getActivity(), ScheduleActivity.class));
                            break;
                        case 2:
      //                      Toast.makeText(getActivity(), "2019년부터 서비스 예정", Toast.LENGTH_SHORT).show();

                           Intent aintent = new Intent(getActivity(),ExamTimeActivity.class);
