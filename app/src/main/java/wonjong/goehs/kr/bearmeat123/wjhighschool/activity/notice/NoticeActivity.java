package wonjong.goehs.kr.bearmeat123.wjhighschool.activity.notice;
...
import wonjong.goehs.kr.bearmeat123.wjhighschool.tool.Database;
...
import wonjong.goehs.kr.bearmeat123.wjhighschool.tool.Tools;
    ...
    private void showNoticeData(boolean forceUpdate) {
        ...
        if (Tools.isOnline(getApplicationContext())) {
            if (Tools.isWifi(getApplicationContext()) || forceUpdate) {
                ...
                mTask.execute("https://docs.google.com/spreadsheets/d/e/2PACX-1vT4V4RAdd2DTz9ljV_LrFXWES1CPqM4M8vaKj6IkCOfYL_U0nXxCxAUF3CHi_XlyipWvBD3TA_EpNUW/pubhtml");
            } else {
