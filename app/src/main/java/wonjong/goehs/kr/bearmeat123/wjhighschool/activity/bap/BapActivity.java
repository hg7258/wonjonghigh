package wonjong.goehs.kr.bearmeat123.wjhighschool.activity.bap;
...
import wonjong.goehs.kr.bearmeat123.wjhighschool.tool.ProcessTask;
...
public class BapActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_calender) {
            ...
            Toast.makeText(this, "개발중입니다!", Toast.LENGTH_LONG).show();
 //           startActivity(new Intent(this, BapStarActivity.class).putExtra("starType", 2));
        }
        else if (id == R.id.alg_inf){
            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setTitle(R.string.alg_name);
            builder.setMessage(R.string.alg_msg);
            builder.setPositiveButton(android.R.string.ok, null);
            builder.show();
        }
